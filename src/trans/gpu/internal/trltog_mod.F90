...
!      IRECV_FLD_START = 1 !! INT(ZCOMBUFR(-1,INR),KIND=JPIM) !! is this always 1 ?
 ...
 &                  PGP,PGPUV,PGP3A,PGP3B,PGP2)
  ...
  !$OMP&    SHARED(NGPBLKS,IGPTRSEND,MYSETW,LLPGPONLY,LLINDER,IFLDS,KPTRGP,INDOFF, &
  !$OMP&           MYPROC,IGPTROFF,PGP,PGLAT,INDEX,IFLDOFF,LLUV,PGPUV,IUVLEVS, &
  !$OMP&           IUVPARS,LLGP2,PGP2,IGP2PARS,LLGP3A,PGP3A,IGP3ALEVS,IGP3APARS, &
  !$OMP&           LLGP3B,PGP3B,IGP3BLEVS,IGP3BPARS,NOUT,INSEND,JSEND, &
  !$OMP&           ISEND_FLD_START,ISENDTOT,KF_FS,ZCOMBUFS,INRECV,JRECV,ZCOMBUFR, &
  !$OMP&           KF_GP,KVSET)
#endif
  ...
  !$OMP&    SHARED(INSEND,JSEND,ISEND_FLD_START,ISENDTOT,KF_FS,INDEX,INDOFF, &
  !$OMP&           ZCOMBUFS,PGLAT)
    DO INS=1,INSEND
      ISEND=JSEND(INS)
  ...
  !$OMP& SHARED(INRECV,JRECV,ZCOMBUFR,KF_GP,KVSET,NGPBLKS,IGPTRSEND, &
  !$OMP&        LLINDER,PGP,KPTRGP,LLPGPONLY,LLUV,PGPUV,IUVLEVS,IUVPARS, &
  !$OMP&        LLGP2,PGP2,IGP2PARS,LLGP3A,PGP3A,IGP3ALEVS,IGP3APARS, &
  !$OMP&        LLGP3B,PGP3B,IGP3BLEVS,IGP3BPARS)
  DO INR=1,INRECV
      IRECV=JRECV(INR)
      CALL PE2SET(IRECV,ISETA,ISETB,ISETW,ISETV)
