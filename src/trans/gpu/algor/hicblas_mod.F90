...
#ifdef OMPGPU
  !$OMP TARGET UPDATE FROM(AARRAY,CARRAY)
  WRITE(6,*) "HIP_SGEMM_GROUPED_OVERLOAD 1:", MINVAL(AARRAY), MAXVAL(AARRAY)
  WRITE(6,*) "HIP_SGEMM_GROUPED_OVERLOAD 2:", MINVAL(CARRAY), MAXVAL(CARRAY)
#endif
